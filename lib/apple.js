...
class Central extends EventEmitter {
  ...
  //
  // Requires `ids` persisted from an earlier scan, or `services` to match
  // peripherals the system already has connected. Unlike the linux and android
  // backends this platform cannot enumerate on its own, because CoreBluetooth
  // identifiers are per host and per application.
